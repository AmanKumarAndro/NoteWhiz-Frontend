...
const Navbar = () => {
  ...
  return (
    <header className="flex w-full bg-primaryColor text-fadeHeading items-center">
        ...
        <div className="relative -mx-4 flex items-center justify-between">
          <div className="w-60 max-w-full px-4">
            <a href="/#" className="block w-full py-5">
              ...
              <h1 className="text-2xl font-semibold text-white">NoteWhiz</h1>
            </a>
          </div>
            ...
            <div>
              ...
              >
                <ul className="block   lg:flex">
                  ...
                  <ListItem NLink="/pricing">Payment</ListItem>
                  <ListItem NLink="/about">About</ListItem>
                  <ListItem NLink="/contact">Contact Us</ListItem>
                </ul>
              </nav>
            </div>
      ...
      {/* <button
        className="absolute top-4 right-4 flex items-center px-3 py-2 rounded-lg text-sm font-medium focus:outline-none"
